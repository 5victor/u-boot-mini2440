...
#define CONFIG_SPL
#define CONFIG_SPL_TEXT_BASE	0x31000000
...
#define CONFIG_SYS_NAND_U_BOOT_SIZE	(512 * 1024) /* 512k */
#define CONFIG_SYS_NAND_U_BOOT_DST	CONFIG_SYS_TEXT_BASE
#define CONFIG_SYS_NAND_U_BOOT_START	CONFIG_SYS_TEXT_BASE
#define CONFIG_SYS_NAND_5_ADDR_CYCLE

/* depend u-boot ecc algorithm?*/
#define CONFIG_SYS_NAND_PAGE_SIZE	2048
#define CONFIG_SYS_NAND_BLOCK_SIZE	(CONFIG_SYS_NAND_PAGE_SIZE * 64)
#define CONFIG_SYS_NAND_PAGE_COUNT	0x20000
